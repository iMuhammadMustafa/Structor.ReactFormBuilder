...
export const validateBuiltInRules = (validationSchema, input, builtInRulesErrors) => {
  if (validationSchema.isRequired) {
    ...
    const errorSchema = { errorName: "isRequired", message: `This field is required`, type: errorTypes.BUILT_IN };
...
export const validateCustomRules = async (customValidators, input, customRulesErrors) => {
  ...
  for (const validator of customValidators) {
    const errorSchema = { errorName: validator.name, message: validator.errorMessage, type: errorTypes.CUSTOM };
